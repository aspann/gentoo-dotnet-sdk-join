...
@pytest.mark.parametrize("level, entry", [
    (logging.NOTSET, 'TEST'),
    (logging.DEBUG,
     '\x1b[33;90m1970-01-01 01:00:00,000\x1b[0m [\x1b[38;20mDEBUG\x1b[0m]\t   \x1b[33;90mTEST\x1b[0m'),
    (logging.INFO,
     '\x1b[33;90m1970-01-01 01:00:00,000\x1b[0m [\x1b[33;32mINFO\x1b[0m]\t   \x1b[31;37mTEST\x1b[0m'),
    (logging.WARNING,
     '\x1b[33;90m1970-01-01 01:00:00,000\x1b[0m [\x1b[33;20mWARNING\x1b[0m]  \x1b[31;37mTEST\x1b[0m'),
    (logging.ERROR,
     '\x1b[33;90m1970-01-01 01:00:00,000\x1b[0m [\x1b[31;20mERROR\x1b[0m]\t   \x1b[1m\x1b[33;97mTEST\x1b[0m'),
    (logging.CRITICAL,
     '\x1b[33;90m1970-01-01 01:00:00,000\x1b[0m [\x1b[31;1mCRITICAL\x1b[0m] \x1b[31;20mTEST\x1b[0m')
])
...
def test_logger_verbosity_parsing(verbosity: str, level: int):
    assert Log(verbosity, "", None).level == level
...
def test_logger_from_args(temp_dir: str, verbosity: str, level: int):
    ...
    assert Log.from_args(args).level == level
